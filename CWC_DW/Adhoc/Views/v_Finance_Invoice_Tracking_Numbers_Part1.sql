...
CREATE VIEW [Adhoc].[v_Finance_Invoice_Tracking_Numbers_Part1]
...
WITH Tracking AS
	(
		...
		WHERE CAST(t.DELIVERYDATE AS DATE) >='1/1/2022' AND NULLIF(TRACKINGNUMBER,'') IS NOT NULL
	)
--,Sales AS
--(
SELECT --TOP 1000
...
WHERE CAST(t.[DLVDATE] AS DATE) BETWEEN '1/1/2022' AND '6/8/2022'
