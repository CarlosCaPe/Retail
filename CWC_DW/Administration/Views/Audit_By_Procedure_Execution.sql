...
SELECT
	...
	,ISNULL(sum(AT_D.Record_Count),0) AS Deleted_Rows
...
FROM	
	...
	LEFT OUTER JOIN [Administration].[Audit_table]			AT_D	ON AT_D.Table_Name = PT.Table_Name
																	AND AT_D.Audit_Date BETWEEN PU.Start_Date	AND PU.End_Date
																	AND AT_D.Operation = 'D'
