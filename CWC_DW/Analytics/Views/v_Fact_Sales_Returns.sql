...
CREATE VIEW [Analytics].[v_Fact_Sales_Returns]
...
SELECT
      ...
      ,[Sales_Line_Amount] = [Sales_Line_Amount] * -1
      ,[Sales_Line_Discount_Amount] = [Sales_Line_Discount_Amount] * -1
      ...
      ,[Sales_Line_Ordered_Quantity] = [Sales_Line_Ordered_Quantity] * -1
  ...
  LEFT JOIN [CWC_DW].[Fact].[Invoices] (NOLOCK) i ON i.Sales_Key = s.Sales_Key
  WHERE soa.[Order_Classification] = 'Return';
