...
CREATE VIEW [Analytics].[v_Fact_Transaction_Lifecycle_BACKUP_110222] AS
...
,Sales AS
	(
		SELECT --TOP 5000 
			 ...
			 [Transaction Lifecycle Date] = CAST(s.Sales_Header_Created_Date AS DATE) --CAST(s.Sales_Line_Created_Date_EST AS DATE)
...
,Returns AS
	(
		SELECT --TOP 500
			...
			,[Transaction Date] = CAST(r.Sales_Header_Created_Date AS DATE) --CAST(r.Sales_Line_Created_Date_EST AS DATE)
