...
CREATE VIEW [Data_Flow].[v_Fact_Purchase_Order_Open_Receipt_Units]
AS
...
SELECT --TOP (1000) 
	...
	,po.[Purchase Order Property Key]
	...
	,[Retail Amount] = (po.[Trade Agreement Price] * [Vendor_Packing_Slip_Quantity])
	--,po.Vendor
	--,po.[Vendor Country]
...
SELECT --TOP (1000) 
	...
	,[Retail Amount] = (po.[Trade Agreement Price] * [Purchase Line Open Quantity])
	--,po.Vendor
	--,po.[Vendor Country]
	--,[Delivery Terms CD] = po.[Vendor Delivery Terms CD]
	--,[Delivery Terms Parent CD] = po.[Vendor Delivery Terms Parent CD]
