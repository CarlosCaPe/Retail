...
GO
CREATE TRIGGER [Fact].[tr_Backorder_Fiscal_Week_Summary_Audit] 
ON [Fact].[Backorder_Fiscal_Week_Summary] 
...
BEGIN
    ...
    END
    EXEC [Administration].[usp_AuditTable_Insert] '[Fact].[Backorder_Fiscal_Week_Summary]', @Operation, @RecordCount
END