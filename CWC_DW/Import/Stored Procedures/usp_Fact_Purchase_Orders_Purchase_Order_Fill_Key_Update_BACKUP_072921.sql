		...
		,Purchase_Order_Fill AS
			(
				...
				FROM PO_Fill pf
					...
					LEFT JOIN [CWC_DW].[Dimension].[Purchase_Order_Fill]   pof ON pf.Purchase_Order_Fill_CD = pof.Purchase_Order_Fill_CD AND plf.Purchase_Order_Line_Fill_CD = pof.Purchase_Order_Line_Fill_CD
			)
